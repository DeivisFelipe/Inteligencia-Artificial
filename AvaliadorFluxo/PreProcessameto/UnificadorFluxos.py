...
# Hiperparametros
FILES_FLUXOS = [
    '/home/deivis/Projetos/large-pcap-analyzer-2/caida02.txt',
    '/home/deivis/Projetos/large-pcap-analyzer-2/caida03.txt',
]
...
for file_name in FILES_FLUXOS:
    ...
    # Exibe os ultimos fluxos inseridos e atualizados
    print("========================================")
    print("Ultimos fluxo inserido:")
    print(last_flow)
    print("========================================")
    print("Ultimos fluxo atualizado:")
    print(last_update_flow)
    print("========================================")
    print("Novo fluxo no ultimos update:")
